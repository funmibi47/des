...
def permute(k, arr, n): 
    """
    k   - key or msg to permute,
    arr - the permutation table,
    n   - number of bits
    """
    permutation = "" 
    for i in range(0, n): 
...
pt = "0123456789ABCDEF" #"123456ABCD132536"
key = "133457799BBCDFF1" #"AABB09182736CCDD"
#result should be 85E813540F0AB405.
